...
|中断下半部-workqueue   |<p>struct delayed_work i2c8_cam_periodic_check_wq={0};<br>void i2c8_cam_periodic_check_report_wq_routine(struct work_struct *data);<br>INIT_DELAYED_WORK(&i2c8_cam_periodic_check_wq ,    i2c8_cam_periodic_check_report_wq_routine);</p>| schedule_delayed_work(&i2c8_cam_periodic_check_wq, msecs_to_jiffies(200)); |  | |
