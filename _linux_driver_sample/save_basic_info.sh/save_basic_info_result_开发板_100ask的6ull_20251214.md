...
##  uname -a 
```
Linux 100ask 4.9.88 #1 SMP PREEMPT Sun Nov 23 01:10:35 CST 2025 armv7l GNU/Linux 
```
...
# CONFIG_ARM_IMX8_CPUFREQ is not set
# CONFIG_ARM_IMX8MQ_CPUFREQ is not set
...
# CONFIG_SPI_FSL_FLEXSPI is not set
CONFIG_MTD_UBI=y
...
# CONFIG_IMX8M_THERMAL is not set
...
CONFIG_IRDA_NEC_MOD=m
CONFIG_IRDA_NEC_RC_MOD=m
...
# CONFIG_SND_SOC_FSL_ACM is not set
# CONFIG_SND_SOC_FSL_AMIX is not set
CONFIG_SND_SOC_FSL_SSI=y
CONFIG_SND_SOC_FSL_SPDIF=y
CONFIG_SND_SOC_FSL_ESAI=y
CONFIG_SND_SOC_FSL_RPMSG_I2S=y
# CONFIG_SND_SOC_FSL_HIFI4 is not set
...
# CONFIG_SND_SOC_IMX_WM8524 is not set
...
# CONFIG_SND_SOC_IMX_AMIX is not set
...
# CONFIG_SND_SOC_AK4458_I2C is not set
# CONFIG_SND_SOC_AK4458_SPI is not set
# CONFIG_SND_SOC_AK4497 is not set
...
# CONFIG_MX8_HDP is not set
# CONFIG_MX8_HDP_DP is not set
# CONFIG_MX8_HDP_HDMI is not set
CONFIG_MXC_IPU=y
CONFIG_MXC_IPU_V3=y
...
# CONFIG_CLKSRC_IMX_SYS_CNT is not set
...
# CONFIG_PHY_MIXEL_MIPI_DSI is not set
...
#
CONFIG_ARM_PMU=y
# CONFIG_IMX8_DDR_PERF is not set
...
/dev/root       772M  648M   69M  91% /
devtmpfs         85M     0   85M   0% /dev
tmpfs           245M     0  245M   0% /dev/shm
tmpfs           245M  276K  245M   1% /tmp
tmpfs           245M  516K  245M   1% /run 
```

#  =====================网络接口信息=====================
    link/ether 00:01:3f:2d:3e:4d brd ff:ff:ff:ff:ff:ff
    inet6 fe80::e47a:a39f:3dcf:6f6c/64 scope link noprefixroute 

##  ifconfig 
```
eth0      Link encap:Ethernet  HWaddr 00:01:3F:2D:3E:4D  
          inet6 addr: fe80::e47a:a39f:3dcf:6f6c/64 Scope:Link
          UP BROADCAST RUNNING MULTICAST  MTU:1500  Metric:1
          RX packets:189 errors:0 dropped:0 overruns:0 frame:0
          TX packets:443 errors:0 dropped:0 overruns:0 carrier:0
          collisions:0 txqueuelen:1000 
          RX bytes:63504 (62.0 KiB)  TX bytes:81211 (79.3 KiB)
...
lo        Link encap:Local Loopback  
          ...
          RX bytes:149184 (145.6 KiB)  TX bytes:149184 (145.6 KiB)

wlan0     Link encap:Ethernet  HWaddr 38:01:46:DB:FC:EE  
          UP BROADCAST MULTICAST  MTU:1500  Metric:1
          RX packets:0 errors:0 dropped:587 overruns:0 frame:0
          TX packets:0 errors:0 dropped:0 overruns:0 carrier:0
          collisions:0 txqueuelen:1000 
          RX bytes:0 (0.0 B)  TX bytes:0 (0.0 B)

wlan1     Link encap:Ethernet  HWaddr 3A:01:46:DB:FC:EE  
          UP BROADCAST MULTICAST  MTU:1500  Metric:1
          RX packets:0 errors:0 dropped:311 overruns:0 frame:0
          TX packets:0 errors:0 dropped:0 overruns:0 carrier:0
          collisions:0 txqueuelen:1000 
          RX bytes:0 (0.0 B)  TX bytes:0 (0.0 B) 
```
...
root            ttymxc0         00:01   Jan  1 00:00:55   
```
...
PID   USER     COMMAND
  ...
  149 root     psplash -n
  153 root     /sbin/syslogd -n
  157 root     /sbin/klogd -n
  169 root     /usr/share/lvgl/lvgl_100ask_demo
  179 root     /sbin/udevd -d
  218 dbus     dbus-daemon --system
  261 root     /usr/sbin/ModemManager
  269 root     /usr/sbin/NetworkManager
  275 root     /usr/sbin/ntpd -g
  281 mosquitt /usr/sbin/mosquitto -c /etc/mosquitto/mosquitto.conf
  287 root     /usr/bin/pulseaudio --system --daemonize --disallow-module-loading --disallow-exit --exit-idle-time=-1 --use-pid-file --disable-shm
  ...
  330 root     /usr/bin/swupdate -f /etc/swupdate/swupdate.cfg -L -e rootfs,rootfs-1 -u -c 1 -i BrImx6ullpro_01-51fa0c600
  345 root     /usr/bin/adbd
  355 root     -bash
  360 root     [kworker/u2:3]
  394 root     [kworker/0:2]
  447 root     [kworker/0:1]
  456 root     [kworker/0:0]
  463 root     /bin/sh -
  466 root     /bin/sh -
  479 root     ps -ef 
```
...
/dev/mmcblk1p1 *  0,65,4      13,0,53           4098     208897     204800  100M 83 Linux
/dev/mmcblk1p2 *  13,0,54     114,252,12      208898    1847297    1638400  800M 83 Linux
/dev/mmcblk1p3    114,252,13  121,92,37      1847298    1949697     102400 50.0M  c Win95 FAT32 (LBA)
...
##  blkid 
```
/dev/mmcblk1p2: UUID="491f6117-415d-4f53-88c9-6e0de54deac6" 
```
...
```
total 3012
drwxr-xr-x  2 root root   4096 Nov 22  2025 .
drwxr-xr-x 21 root root   4096 Jan  1 00:58 ..
-rwxr-xr-x  1 root root   5408 Nov 22  2025 arch
-rwxr-xr-x  1 root root   5408 Nov 22  2025 ash
-rwxr-xr-x  1 root root  30312 Nov 22  2025 base64
-rwxr-xr-x  1 root root 643804 Nov 22  2025 bash
-rwxr-xr-x  1 root root  26248 Nov 22  2025 cat
-rwxr-xr-x  1 root root   9640 Nov 22  2025 chattr
-rwxr-xr-x  1 root root  50900 Nov 22  2025 chgrp
-rwxr-xr-x  1 root root  46776 Nov 22  2025 chmod
-rwxr-xr-x  1 root root  50908 Nov 22  2025 chown
-rwxr-xr-x  1 root root   1342 Nov 22  2025 compile_et
-rwxr-xr-x  1 root root  96224 Nov 22  2025 cp
-rwxr-xr-x  1 root root 110372 Nov 22  2025 cpio
-rwxr-xr-x  1 root root  71348 Nov 22  2025 date
-rwxr-xr-x  1 root root  50932 Nov 22  2025 dd
-rwxr-xr-x  1 root root  63596 Nov 22  2025 df
-rwxr-xr-x  1 root root 108676 Nov 22  2025 dir
-rwxr-xr-x  1 root root   5408 Nov 22  2025 dmesg
-rwxr-xr-x  1 root root   5408 Nov 22  2025 dnsdomainname
-rwxr-xr-x  1 root root   5408 Nov 22  2025 dumpkmap
-rwxr-xr-x  1 root root  22064 Nov 22  2025 echo
-rwxr-xr-x  1 root root     28 Nov 22  2025 egrep
-rwxr-xr-x  1 root root  17956 Nov 22  2025 false
-rwxr-xr-x  1 root root   5408 Nov 22  2025 fdflush
-rwxr-xr-x  1 root root     28 Nov 22  2025 fgrep
-rwxr-xr-x  1 root root  47244 Nov 22  2025 fuse2fs
-rwxr-xr-x  1 root root   5408 Nov 22  2025 getopt
-rwxr-xr-x  1 root root 153504 Nov 22  2025 grep
-rwxr-xr-x  1 root root   5408 Nov 22  2025 gunzip
-rwxr-xr-x  1 root root   5408 Nov 22  2025 gzip
-rwxr-xr-x  1 root root   5408 Nov 22  2025 hostname
-rwxr-xr-x  1 root root  34448 Nov 22  2025 join
-rwxr-xr-x  1 root root  26636 Nov 22  2025 kill
-rwxr-xr-x  1 root root  22088 Nov 22  2025 link
-rwxr-xr-x  1 root root   5408 Nov 22  2025 linux32
-rwxr-xr-x  1 root root   5408 Nov 22  2025 linux64
-rwxr-xr-x  1 root root  50948 Nov 22  2025 ln
-rwsr-xr-x  1 root root   5408 Nov 22  2025 login
-rwxr-xr-x  1 root root 108676 Nov 22  2025 ls
-rwxr-xr-x  1 root root   9636 Nov 22  2025 lsattr
-rwxr-xr-x  1 root root   1102 Nov 22  2025 mk_cmds
-rwxr-xr-x  1 root root  55080 Nov 22  2025 mkdir
-rwxr-xr-x  1 root root  50960 Nov 22  2025 mknod
-rwxr-xr-x  1 root root  34464 Nov 22  2025 mktemp
-rwxr-xr-x  1 root root   5408 Nov 22  2025 more
-rwsr-xr-x  1 root root   5408 Nov 22  2025 mount
-rwxr-xr-x  1 root root   5408 Nov 22  2025 mountpoint
-rwxr-xr-x  1 root root   5408 Nov 22  2025 mt
-rwxr-xr-x  1 root root  92132 Nov 22  2025 mv
-rwxr-xr-x  1 root root   5408 Nov 22  2025 netstat
-rwxr-xr-x  1 root root  26200 Nov 22  2025 nice
-rwxr-xr-x  1 root root   5408 Nov 22  2025 nuke
-rwxr-xr-x  1 root root   5408 Nov 22  2025 pidof
-rwsr-xr-x  1 root root   5408 Nov 22  2025 ping
-rwxr-xr-x  1 root root   5408 Nov 22  2025 pipe_progress
-rwxr-xr-x  1 root root  22084 Nov 22  2025 printenv
-rwxr-xr-x  1 root root   5408 Nov 22  2025 ps
-rwxr-xr-x  1 root root  30376 Nov 22  2025 pwd
-rwxr-xr-x  1 root root   5408 Nov 22  2025 resume
-rwxr-xr-x  1 root root  50892 Nov 22  2025 rm
-rwxr-xr-x  1 root root  26212 Nov 22  2025 rmdir
-rwxr-xr-x  1 root root   5408 Nov 22  2025 run-parts
-rwxr-xr-x  1 root root 124872 Nov 22  2025 sed
-rwxr-xr-x  1 root root   5408 Nov 22  2025 setarch
-rwxr-xr-x  1 root root   5408 Nov 22  2025 setpriv
-rwxr-xr-x  1 root root   5408 Nov 22  2025 setserial
lrwxrwxrwx  1 root root      4 Nov 22  2025 sh -> bash
-rwxr-xr-x  1 root root  26196 Nov 22  2025 sleep
-rwxr-xr-x  1 root root  46732 Nov 22  2025 stty
-rwsr-xr-x  1 root root   5408 Nov 22  2025 su
-rwxr-xr-x  1 root root  26208 Nov 22  2025 sync
-rwxr-xr-x  1 root root   5408 Nov 22  2025 tar
-rwxr-xr-x  1 root root  63160 Nov 22  2025 touch
-rwxr-xr-x  1 root root  17956 Nov 22  2025 true
-rwxr-xr-x  1 root root   5408 Nov 22  2025 umount
-rwxr-xr-x  1 root root  26192 Nov 22  2025 uname
-rwxr-xr-x  1 root root   5408 Nov 22  2025 usleep
-rwxr-xr-x  1 root root 108676 Nov 22  2025 vdir
-rwxr-xr-x  1 root root   5408 Nov 22  2025 vi
-rwxr-xr-x  1 root root   5408 Nov 22  2025 watch
-rwxr-xr-x  1 root root   5408 Nov 22  2025 zcat 
```
...
```
total 0
drwxr-xr-x 10 root root    0 Jan  1 00:58 .
...
drwxr-xr-x  2 root root    0 Jan  1 00:58 power
...
```
total 0
drwx------  28 root root 0 Jan  1 00:00 .
drwxr-xr-x   9 root root 0 Jan  1 00:01 ..
drwxr-xr-x   3 root root 0 Jan  1 00:00 asoc
drwxr-xr-x  31 root root 0 Jan  1 00:00 bdi
drwxr-xr-x   3 root root 0 Jan  1 00:00 bluetooth
drwxr-xr-x   2 root root 0 Jan  1 00:00 ci_hdrc.0
drwxr-xr-x   2 root root 0 Jan  1 00:00 ci_hdrc.1
drwxr-xr-x 224 root root 0 Jan  1 00:00 clk
drwxr-xr-x   2 root root 0 Jan  1 00:00 dma_buf
drwxr-xr-x   3 root root 0 Jan  1 00:00 dri
drwxr-xr-x   2 root root 0 Jan  1 00:00 dynamic_debug
drwxr-xr-x   2 root root 0 Jan  1 00:00 extfrag
...
drwxr-xr-x   4 root root 0 Jan  1 00:00 ieee80211
drwxr-xr-x   3 root root 0 Jan  1 00:00 iio
drwxr-xr-x   2 root root 0 Jan  1 00:00 memblock
drwxr-xr-x   2 root root 0 Jan  1 00:00 mmc0
drwxr-xr-x   3 root root 0 Jan  1 00:00 mmc1
drwxr-xr-x   3 root root 0 Jan  1 00:00 opp
drwxr-xr-x   4 root root 0 Jan  1 00:00 pinctrl
drwxr-xr-x   2 root root 0 Jan  1 00:00 pm_genpd
drwxr-xr-x   2 root root 0 Jan  1 00:00 pm_qos
-r--r--r--   1 root root 0 Jan  1 00:00 pwm
drwxr-xr-x   8 root root 0 Jan  1 00:00 regmap
drwxr-xr-x   9 root root 0 Jan  1 00:00 regulator
-r--r--r--   1 root root 0 Jan  1 00:00 sleep_time
-r--r--r--   1 root root 0 Jan  1 00:00 suspend_stats
dr-xr-xr-x   3 root root 0 Jan  1 00:00 tracing
drwxr-xr-x   2 root root 0 Jan  1 00:00 ubi
drwxr-xr-x   2 root root 0 Jan  1 00:00 ubifs
drwxr-xr-x   4 root root 0 Jan  1 00:00 usb
...
```
total 0
drwxr-xr-x  2 root root 0 Jan  1 00:58 .
drwxr-xr-x 54 root root 0 Jan  1 00:00 ..
lrwxrwxrwx  1 root root 0 Jan  1 00:00 video0 -> ../../devices/soc0/pxp_v4l2/video4linux/video0 
```
...
Bounce:                0 kB
WritebackTmp:          0 kB
CommitLimit:      250472 kB
Committed_AS:     298744 kB
...
80000000-9fffffff : System RAM
  80008000-810fffff : Kernel code
  81200000-8138c6d7 : Kernel data 
```
...
IPI5:      37637  IRQ work interrupts
...
```
total 4
drwxr-xr-x 13 root root        3360 Jan  1 00:00 .
drwxr-xr-x 21 root root        4096 Jan  1 00:58 ..
...
brw-rw----  1 root disk    179,   0 Jan  1 00:00 mmcblk1
brw-rw----  1 root disk    179,   8 Jan  1 00:00 mmcblk1boot0
brw-rw----  1 root disk    179,  16 Jan  1 00:00 mmcblk1boot1
brw-rw----  1 root disk    179,   1 Jan  1 00:00 mmcblk1p1
brw-rw----  1 root disk    179,   2 Jan  1 00:00 mmcblk1p2
brw-rw----  1 root disk    179,   3 Jan  1 00:00 mmcblk1p3
brw-rw----  1 root disk    179,  24 Jan  1 00:00 mmcblk1rpmb
...
crw-rw-rw-  1 root tty       5,   2 Jan  1 00:58 ptmx
...
crw-------  1 root root    207,  16 Jan  1 00:57 ttymxc0
crw-rw----  1 root dialout 207,  18 Jan  1 00:00 ttymxc2
crw-rw----  1 root dialout 207,  21 Jan  1 00:00 ttymxc5
crw-------  1 root root     10,  57 Jan  1 00:00 ubi_ctrl
crw-rw-rw-  1 root root      1,   9 Jan  1 00:00 urandom
drwxrwx---  3 root root          60 Jan  1 00:00 usb-ffs
...
```
-rw-r--r-- 1 root root  34164 Nov 22  2025 /lib/modules/4.9.88/kernel/drivers/media/platform/mxc/capture/ov5640_camera_int.ko
-rw-r--r-- 1 root root  36992 Nov 22  2025 /lib/modules/4.9.88/kernel/drivers/media/platform/mxc/capture/ov5640_camera_mipi_int.ko
-rw-r--r-- 1 root root  28808 Nov 22  2025 /lib/modules/4.9.88/kernel/drivers/media/platform/mxc/capture/ov5640_camera_mipi_v2.ko
-rw-r--r-- 1 root root  32584 Nov 22  2025 /lib/modules/4.9.88/kernel/drivers/media/platform/mxc/capture/ov5640_camera_v2.ko
-rw-r--r-- 1 root root  91428 Nov 22  2025 /lib/modules/4.9.88/kernel/drivers/media/platform/mxc/capture/ov5642_camera.ko
-rw-r--r-- 1 root root  27224 Nov 22  2025 /lib/modules/4.9.88/kernel/drivers/media/platform/mxc/capture/ov5647_camera_mipi.ko
-rwxr-xr-x 1 root root  71912 Nov 22  2025 /usr/lib/gstreamer-1.0/libgstcamerabin.so
lrwxrwxrwx 1 root root     31 Nov 22  2025 /usr/lib/libgstbasecamerabinsrc-1.0.so -> libgstbasecamerabinsrc-1.0.so.0
lrwxrwxrwx 1 root root     38 Nov 22  2025 /usr/lib/libgstbasecamerabinsrc-1.0.so.0 -> libgstbasecamerabinsrc-1.0.so.0.1602.0
-rwxr-xr-x 1 root root  22068 Nov 22  2025 /usr/lib/libgstbasecamerabinsrc-1.0.so.0.1602.0
-rw-r--r-- 1 root root   9107 Feb 21  2020 /usr/lib/qt/examples/canvas3d/threejs/cellphone/images/camera.png
-rw-r--r-- 1 root root   3253 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/CameraButton.qml
-rw-r--r-- 1 root root   3194 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/CameraListButton.qml
-rw-r--r-- 1 root root   3994 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/CameraListPopup.qml
-rw-r--r-- 1 root root   3260 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/CameraPropertyButton.qml
-rw-r--r-- 1 root root   4266 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/CameraPropertyPopup.qml
-rwxr-xr-x 1 root root  71096 Nov 22  2025 /usr/lib/qt/examples/multimedia/declarative-camera/declarative-camera
-rw-r--r-- 1 root root    247 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/declarative-camera.pro
-rw-r--r-- 1 root root   5188 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/declarative-camera.qml
-rw-r--r-- 1 root root    400 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/declarative-camera.qmlproject
-rw-r--r-- 1 root root   1226 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/declarative-camera.qrc
-rw-r--r-- 1 root root    778 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/images/camera_auto_mode.png
-rw-r--r-- 1 root root    717 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/images/camera_camera_setting.png
-rw-r--r-- 1 root root   1119 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/images/camera_flash_auto.png
-rw-r--r-- 1 root root    610 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/images/camera_flash_fill.png
-rw-r--r-- 1 root root    717 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/images/camera_flash_off.png
-rw-r--r-- 1 root root    945 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/images/camera_flash_redeye.png
-rw-r--r-- 1 root root    625 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/images/camera_white_balance_cloudy.png
-rw-r--r-- 1 root root    554 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/images/camera_white_balance_flourescent.png
-rw-r--r-- 1 root root    600 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/images/camera_white_balance_incandescent.png
-rw-r--r-- 1 root root    587 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/images/camera_white_balance_sunny.png
-rw-r--r-- 1 root root   3036 Mar 16  2020 /usr/lib/qt/examples/multimedia/declarative-camera/qmlcamera.cpp
-rw-r--r-- 1 root root   2530 Mar 16  2020 /usr/lib/qt/examples/multimedia/video/qmlvideo/qml/qmlvideo/CameraBasic.qml
-rw-r--r-- 1 root root   2511 Mar 16  2020 /usr/lib/qt/examples/multimedia/video/qmlvideo/qml/qmlvideo/CameraDrag.qml
-rw-r--r-- 1 root root   3106 Mar 16  2020 /usr/lib/qt/examples/multimedia/video/qmlvideo/qml/qmlvideo/CameraDummy.qml
-rw-r--r-- 1 root root   2518 Mar 16  2020 /usr/lib/qt/examples/multimedia/video/qmlvideo/qml/qmlvideo/CameraFullScreen.qml
-rw-r--r-- 1 root root   2526 Mar 16  2020 /usr/lib/qt/examples/multimedia/video/qmlvideo/qml/qmlvideo/CameraFullScreenInverted.qml
-rw-r--r-- 1 root root   2995 Mar 16  2020 /usr/lib/qt/examples/multimedia/video/qmlvideo/qml/qmlvideo/CameraItem.qml
-rw-r--r-- 1 root root   2511 Mar 16  2020 /usr/lib/qt/examples/multimedia/video/qmlvideo/qml/qmlvideo/CameraMove.qml
-rw-r--r-- 1 root root   2514 Mar 16  2020 /usr/lib/qt/examples/multimedia/video/qmlvideo/qml/qmlvideo/CameraOverlay.qml
-rw-r--r-- 1 root root   2513 Mar 16  2020 /usr/lib/qt/examples/multimedia/video/qmlvideo/qml/qmlvideo/CameraResize.qml
-rw-r--r-- 1 root root   2513 Mar 16  2020 /usr/lib/qt/examples/multimedia/video/qmlvideo/qml/qmlvideo/CameraRotate.qml
-rw-r--r-- 1 root root   2511 Mar 16  2020 /usr/lib/qt/examples/multimedia/video/qmlvideo/qml/qmlvideo/CameraSpin.qml
-rw-r--r-- 1 root root   2569 Mar 16  2020 /usr/lib/qt/examples/multimedia/video/qmlvideofx/qml/qmlvideofx/ContentCamera.qml
-rwxr-xr-x 1 root root  72548 Nov 22  2025 /usr/lib/qt/examples/multimediawidgets/camera/camera
-rw-r--r-- 1 root root  13570 Mar 16  2020 /usr/lib/qt/examples/multimediawidgets/camera/camera.cpp
-rw-r--r-- 1 root root   4412 Mar 16  2020 /usr/lib/qt/examples/multimediawidgets/camera/camera.h
-rw-r--r-- 1 root root    465 Mar 16  2020 /usr/lib/qt/examples/multimediawidgets/camera/camera.pro
-rw-r--r-- 1 root root    102 Mar 16  2020 /usr/lib/qt/examples/multimediawidgets/camera/camera.qrc
-rw-r--r-- 1 root root  13021 Mar 16  2020 /usr/lib/qt/examples/multimediawidgets/camera/camera.ui
-rw-r--r-- 1 root root   3540 Mar 16  2020 /usr/lib/qt/examples/quick/views/gridview/pics/Camera_48.png
-rw-r--r-- 1 root root   3540 Mar 16  2020 /usr/lib/qt/examples/quick/views/pathview/pics/Camera_48.png
-rwxr-xr-x 1 root root 167496 Nov 22  2025 /usr/lib/qt/plugins/mediaservice/libgstcamerabin.so
-rw-r--r-- 1 root root    481 Oct 27  2025 /usr/share/lvgl/100ask_demo_png_icon/100ask_icon_camera.png

/sys/bus/platform/drivers/soc-camera-pdrv:
total 0
drwxr-xr-x   2 root root    0 Jan  1 00:58 .
drwxr-xr-x 182 root root    0 Jan  1 00:00 ..
--w-------   1 root root 4096 Jan  1 00:58 bind
--w-------   1 root root 4096 Jan  1 00:00 uevent
--w-------   1 root root 4096 Jan  1 00:58 unbind

/usr/lib/qt/examples/multimedia/declarative-camera:
total 172
drwxr-xr-x  3 root root  4096 Nov 22  2025 .
drwxr-xr-x 12 root root  4096 Nov 22  2025 ..
-rw-r--r--  1 root root  3253 Mar 16  2020 CameraButton.qml
-rw-r--r--  1 root root  3194 Mar 16  2020 CameraListButton.qml
-rw-r--r--  1 root root  3994 Mar 16  2020 CameraListPopup.qml
-rw-r--r--  1 root root  3260 Mar 16  2020 CameraPropertyButton.qml
-rw-r--r--  1 root root  4266 Mar 16  2020 CameraPropertyPopup.qml
-rw-r--r--  1 root root  2898 Mar 16  2020 FocusButton.qml
-rw-r--r--  1 root root  6197 Mar 16  2020 PhotoCaptureControls.qml
-rw-r--r--  1 root root  2814 Mar 16  2020 PhotoPreview.qml
-rw-r--r--  1 root root  3121 Mar 16  2020 Popup.qml
-rw-r--r--  1 root root  5058 Mar 16  2020 VideoCaptureControls.qml
-rw-r--r--  1 root root  3040 Mar 16  2020 VideoPreview.qml
-rw-r--r--  1 root root  4388 Mar 16  2020 ZoomControl.qml
-rwxr-xr-x  1 root root 71096 Nov 22  2025 declarative-camera
-rw-r--r--  1 root root   247 Mar 16  2020 declarative-camera.pro
-rw-r--r--  1 root root  5188 Mar 16  2020 declarative-camera.qml
-rw-r--r--  1 root root   400 Mar 16  2020 declarative-camera.qmlproject
-rw-r--r--  1 root root  1226 Mar 16  2020 declarative-camera.qrc
drwxr-xr-x  2 root root  4096 Nov 22  2025 images
-rw-r--r--  1 root root  3036 Mar 16  2020 qmlcamera.cpp

/usr/lib/qt/examples/multimediawidgets/camera:
total 172
drwxr-xr-x 3 root root  4096 Nov 22  2025 .
drwxr-xr-x 7 root root  4096 Nov 22  2025 ..
-rwxr-xr-x 1 root root 72548 Nov 22  2025 camera
-rw-r--r-- 1 root root 13570 Mar 16  2020 camera.cpp
-rw-r--r-- 1 root root  4412 Mar 16  2020 camera.h
-rw-r--r-- 1 root root   465 Mar 16  2020 camera.pro
-rw-r--r-- 1 root root   102 Mar 16  2020 camera.qrc
-rw-r--r-- 1 root root 13021 Mar 16  2020 camera.ui
drwxr-xr-x 2 root root  4096 Nov 22  2025 images
-rw-r--r-- 1 root root  5061 Mar 16  2020 imagesettings.cpp
-rw-r--r-- 1 root root  3470 Mar 16  2020 imagesettings.h
-rw-r--r-- 1 root root  3167 Mar 16  2020 imagesettings.ui
-rw-r--r-- 1 root root  2633 Mar 16  2020 main.cpp
-rw-r--r-- 1 root root  7811 Mar 16  2020 videosettings.cpp
-rw-r--r-- 1 root root  3435 Mar 16  2020 videosettings.h
-rw-r--r-- 1 root root  6216 Mar 16  2020 videosettings.ui 
```
